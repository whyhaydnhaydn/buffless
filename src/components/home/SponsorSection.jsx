      ...
      <div className="relative max-w-7xl mx-auto px-6">
        <div className="max-w-2xl">
          ...
          >
            ...
            <button className="group inline-flex items-center gap-3 text-white font-semibold text-sm uppercase tracking-wider hover:text-[#E10600] transition-colors duration-300">
              Learn More
